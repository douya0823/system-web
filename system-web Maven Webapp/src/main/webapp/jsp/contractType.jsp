...
<script type="text/javascript" src="<%=path%>/js/contractType.js"></script>
<style type="text/css">
...
<form id="queryForm" style="margin-bottom: 0px;"">
	<div id="tb" style="padding-top: 10px;padding-bottom: 10px">
		...
		<span>名称:</span> <input name="name" style="line-height: 26px; border: 1px solid #ccc" /> 
		<span>编码:</span> <input name="code" style="line-height: 26px; border: 1px solid #ccc" />
...
<table id="contractType" class="easyui-datagrid" title="合同类型"
...
<div id="editDialog" class="easyui-dialog" title="新增""
        ...
        <form id="contractTypeInfo" method="post" style="margin-top: 20px; margin-left: 20px;">
