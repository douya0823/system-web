...
<script type="text/javascript" src="<%=path%>/js/contractModel.js"></script>
<style type="text/css">
...
<form id="queryForm" style="margin-bottom: 0px;"">
	<div id="tb" style="padding-top: 10px;padding-bottom: 10px">
        ...
        <span>模板名称</span>
        <input id="model_name" name="name" style="line-height: 23px; border: 1px solid #ccc" /> 
<!-- 		<span>合同编码:</span> 
...
<table id="contractModel" class="easyui-datagrid" title="合同模板"
...
<div id="editDialog" class="easyui-dialog" title="新增""
        ...
        <form id="contractModelInfo" method="post" style="margin-top: 20px; margin-left: 20px;">
            ...
            <div class="fitem">
                <label>合同类型:</label>
                <select id="contractType" name="contractType" class="addselect" style="width:100px;">
                </select>
            </div>
			<div class="fitem">
				<label>模板名称:</label> 
				<input id="modelName" name="name" class="easyui-textbox"  />
			</div>
