...
<form id="queryForm" style="margin-bottom: 0px;"">
	<div id="tb" style="padding-top: 10px;padding-bottom: 10px">
		...
		<span>城市:</span> <input name="name" style="line-height: 26px; border: 1px solid #ccc" /> 
		<span>编号:</span> <input name="code" style="line-height: 26px; border: 1px solid #ccc" />
...
<table id="city" class="easyui-datagrid" title="贷款城市"
...
<div id="editDialog" class="easyui-dialog" title="新增""
        ...
        <form id="cityInfo" method="post" style="margin-top: 20px; margin-left: 20px;">
